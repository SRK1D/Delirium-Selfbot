...
def feetCommand(event):
    """Sends a male feet image from r/Male_feet on deddit
    ...
    feetSub = rP.subreddit("r/male_feet")
...
settings.commandsInfo[fileName] = ";malefeet <no settings> - [NSFW] Generates a male feet picture (only for LEET <3)"